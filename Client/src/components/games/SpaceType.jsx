...
const wordList = [
  ...
  "bat", "cat", "dog", "red", "box", "top", "sun", "car", "bag", "pen",
  "cap", "fun", "hat", "log", "man", "map", "pop", "run", "row", "wet",
  
  // Medium Words: (4 characters)
  "blue", "tree", "game", "fire", "wolf", "zoom", "jump", "rock", "star", "cold",
  "dark", "lamp", "rain", "ship", "time", "wave", "gift", "good", "grow", "high",
  
  // Long Words: (5 characters)
  "apple", "beach", "cloud", "dance", "flame", "grass", "heart", "jelly", "light", "movie",
  "night", "ocean", "party", "queen", "river", "shine", "smile", "space", "storm", "sugar",
  
  // Advanced Level: Words with 6+ characters
  "banana", "bridge", "castle", "charge", "circle", "dragon", "flight", "flower", "forest", "future",
  "android", "captain", "control", "crystal", "decline", "density", "diamond", "discuss", "element", "fiction"
];
