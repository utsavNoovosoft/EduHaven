    ...
    <div className="max-w-md mx-auto p-6 bg-black rounded-xl shadow-lg select-none text-white font-mono border border-white">
      <div className="bg-white rounded-lg p-4 mb-6 min-h-[80px] flex flex-col justify-center border border-black">
        <input
          ...
          className="bg-transparent outline-none w-full text-2xl font-semibold text-cyan-400 placeholder-cyan-600"
        />
  ...
  return (
    <div className="max-w-md mx-auto flex flex-col space-y-2 text-white p-4">
      ...
      <input
        ...
        className="p-2 rounded bg-slate-800 border border-cyan-600 text-white placeholder-cyan-400 outline-none"
      />
      <canvas
        ref={canvasRef}
        width={400}
        height={200}
        className="border h-80 w-160 border-cyan-600 rounded bg-amber-50"
      />
    ...
    <div className="max-w-md mx-auto space-y-5 bg-slate-900 p-6 rounded-xl shadow-lg border border-cyan-700">
      ...
      <div className="flex items-end gap-3">
        ...
        <button
          ...
          className="px-3 py-2 rounded bg-cyan-600 text-white hover:bg-cyan-700 transition"
        >
          ⇄
        </button>
        <div className="flex-1">
