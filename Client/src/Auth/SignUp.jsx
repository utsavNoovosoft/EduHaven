...
function SignUp() {
  ...
  return (
    <div className="max-w-sm w-full mx-auto p-7 space-y-3 bg-white dark:bg-gray-800 rounded-xl shadow-md">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            className="block w-full rounded-xl bg-transparent border border-gray-400 px-3 py-2 text-gray-900 dark:text-gray-300 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm mt-1"
          />
        ...
        <div className="flex gap-4">
          <div className="w-1/2">
            ...
            <input
              ...
              className="block w-full rounded-xl border bg-transparent border-gray-400 px-3 py-2 text-gray-900 dark:text-gray-300 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-600 focus:border-indigo-600 sm:text-sm mt-1"
            />
        ...
        <div>
          <label htmlFor="password" className="block text-sm font-medium text-gray-900 dark:text-gray-300 mb-1">
            Password
            <span className={`text-sm font-semibold ml-2 ${strengthLevels[strength - 1]?.color || ""}`}>
